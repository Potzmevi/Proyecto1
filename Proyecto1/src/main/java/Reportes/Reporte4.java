...
public class Reporte4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 310, 170, 30));

        jLabel11.setFont(new java.awt.Font("Ubuntu", 1, 21)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(51, 51, 51));
        jLabel11.setText("Pedidos en transito:");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(23, 80, 580, 200));

        jLabel2.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(51, 51, 51));
        jLabel2.setText("Nombre del Reporte:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 280, 150, 20));

        Nombretxt.setBackground(new java.awt.Color(153, 153, 153));
        Nombretxt.setForeground(new java.awt.Color(51, 51, 51));
        jPanel1.add(Nombretxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 310, 150, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Reporte4.jpg"))); // NOI18N
