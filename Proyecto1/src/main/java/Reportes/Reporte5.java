...
public class Reporte5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 390, 170, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(23, 110, 580, 250));

        jLabel2.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(51, 51, 51));
        jLabel2.setText("Filtrar Nit:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 70, 90, 30));

        Nombretxt.setBackground(new java.awt.Color(153, 153, 153));
        Nombretxt.setForeground(new java.awt.Color(51, 51, 51));
        jPanel1.add(Nombretxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 390, 150, 30));

        nittxt.setBackground(new java.awt.Color(153, 153, 153));
        nittxt.setForeground(new java.awt.Color(51, 51, 51));
        jPanel1.add(nittxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, 210, 30));

        jLabel3.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(51, 51, 51));
        jLabel3.setText("Nombre del Reporte:");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 360, 150, 20));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 70, 110, 30));
